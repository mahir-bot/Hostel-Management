...
$user = $_SESSION['user'];
$query = mysqli_query($connection, "SELECT id from user_credential WHERE id='$user'");
...
<body background="Background.jpg">
  ...
  <br>
    <div class="table">
        <div class="main">
            <div class="content">
                <div class="data-cell"><h3>First Name</h3></div>
                <div class="data-cell">
                <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>Last Name</h3></div>
                <div class="data-cell">
                    <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>ID</h3></div>
                <div class="data-cell">
                    <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>Batch</h3></div>
                <div class="data-cell">
                    <?php
                            if ($row['section'] != NULL)
            ...
            <div class="content">
                <div class="data-cell"><h3>Department</h3></div>
                <div class="data-cell">
                    <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>Credit</h3></div>
                <div class="data-cell">
                    <?php
                            if ($row['credit'] != NULL)
            ...
            <div class="content">
                <div class="data-cell"><h3>Phone</h3></div>
                <div class="data-cell">
                    <?php
                            if ($row['phone'] != NULL)
            ...
            <div class="content">
                <div class="data-cell"><h3>Email</h3></div>
                <div class="data-cell">
                    <div class="email">
                    <?php
                            if ($row['email'] != NULL)
            ...
            <div class="content">
                <div class="data-cell"><h3>Local Address</h3></div>
                <div class="data-cell">
                    <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>Permanent Address</h3></div>
                <div class="data-cell">
                    <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>Gender</h3></div>
                <div class="data-cell">
                    <?php
                            if ($row['gender'] != NULL)
            ...
            <div class="content">
                <div class="data-cell"><h3>Religion</h3></div>
                <div class="data-cell">
                    <?php
            ...
            <div class="content">
                <div class="data-cell"><h3>Blood Group</h3></div>
                <div class="data-cell">
                    <?php
                            if ($row['blood'] != NULL)
            ...
            <div class="button"><a href="updateinfo.html">Update</a></div>
        </div>
    </div>
